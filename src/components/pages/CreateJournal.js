...
class CreateJournal extends Component {
  ...
  return(
   ...
   Publish post
      ...
      <div style={editorStyle} className="mb-10 max-w-4xl">
    <Editor
  ...
  />
    ...
    //         </button>
    //         <div id="tooltip-fullscreen" role="tooltip" className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700" style={{position: "absolute", inset: "auto auto 0px 0px", margin: "0px", transform: "translate(1181px, 229px)"}} data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top">
    //           Show full screen
    //           <div className="tooltip-arrow" data-popper-arrow="" style={{position: "absolute", left: "0px", transform: "translate(63px, 0px)"}}></div>
    //         </div>
    //       </div>
